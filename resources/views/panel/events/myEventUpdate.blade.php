...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('events.update',$myEvent->id) }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('category_id') is-invalid @enderror"
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ $myEvent->category_id == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                            <a href="{{ route('organizer.index') }}" class="btn btn-light">
